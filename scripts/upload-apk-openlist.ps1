...
.DESCRIPTION
    Dedicated uploader for the OpenList instance at http://10.1.1.4:5244.
    Uses File-Path header and As-Task: false, which is required by OpenList v4.
.PARAMETER Server
    OpenList server base URL. Defaults to http://10.1.1.4:5244.
.PARAMETER Token
...
#>
param(
    [string]$Server = "http://10.1.1.4:5244",
